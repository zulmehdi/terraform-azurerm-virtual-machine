...
resource "azurerm_linux_virtual_machine" "vm_linux" {
  count = local.is_linux && local.ignore_custom_data_changes == 0 ? 1 : 0
...
resource "azurerm_linux_virtual_machine" "vm_linux_ignore_custom_data_changes" {
  count = local.is_linux && local.ignore_custom_data_changes ? 1 : 0
